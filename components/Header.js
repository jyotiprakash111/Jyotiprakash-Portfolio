...
const Header = ({ data }) => {
  ...
  return (
    <header id="home" className="hero-shell" data-reveal style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
      <ParticlesBg
        type="cobweb"
        color="#ffffff"
        num={60}
      ...
      <nav id="nav-wrap" data-hero-item style={{ position: 'relative', zIndex: 10 }}>
        <a 
      ...
      <div className="row banner hero-banner" style={{ position: 'relative', zIndex: 5 }}>
        <div className="banner-text hero-banner-text">
          <div className="container hero-layout">
            <div className="hero-copy">
              <span className="hero-kicker" data-hero-item>Immersive Portfolio Experience</span>
              <h1 className="responsive-headline" data-hero-item>
                Hey I'm {name || "Jyotiprakash"}
              </h1>
              <h3 data-hero-item>{description || "Web Developer & Mobile App Engineer"}</h3>
              <hr data-hero-item />
              {networks && networks.length > 0 && (
                <ul className="social" data-hero-item>{networks}</ul>
              )}
            </div>
            <SplineHero />
          </div>
      ...
      <p className="scrolldown" data-hero-item style={{ position: 'relative', zIndex: 5 }}>
